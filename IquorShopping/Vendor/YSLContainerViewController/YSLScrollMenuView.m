...
static const CGFloat kYSLScrollMenuViewMargin = 1;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemSelectTitleFont = [UIFont systemFontOfSize:16];
...
- (void)setItemTitleArray:(NSArray *)itemTitleArray
{
    if (_itemTitleArray != itemTitleArray) {
        ...
        kYSLScrollMenuViewWidth = ([UIScreen mainScreen].bounds.size.width-(itemTitleArray.count-1))/itemTitleArray.count;
...
//                                 label.alpha = 1.0;
                                 ...
                                 label.font = _itemSelectTitleFont;
